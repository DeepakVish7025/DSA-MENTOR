...
const getProblemById = async(req,res)=>{
  ...
  try{
    ...
    const getProblem = await Problem.findById(id).select('_id title description difficulty tags visibleTestCases startCode referenceSolution videoUrl');
...
const solvedAllProblembyUser =  async(req,res)=>{
    ...
    try{
      ...
      res.status(200).send(user.problemSolved.filter(p => p !== null));
